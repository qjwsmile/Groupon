...
public class DealAdapter extends MyBasseAadapter<Group.DealsBean>{
    public DealAdapter(Context context, List<Group.DealsBean> datas) {
        super(context, datas);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Group.DealsBean deal = getItem(i);
        //TODO 呈现图片
        HttpUtil.loadImageRetrogit(context,deal.getS_image_url(),vh.ivPic);
